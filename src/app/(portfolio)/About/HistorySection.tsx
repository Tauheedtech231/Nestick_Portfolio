...
export default function HistorySection() {
  ...
  return (
    ...
    >
      ...
      {/* Full Width Card - Mobile responsive with content on top, image below */}
          ...
          <div className="block md:hidden">
            ...
            <div className="px-6 py-8" style={{ background: NAVY_DEEP }}>
              ...
              >
                ...
                <span 
                  className="text-[11px] font-bold tracking-[1.6px] uppercase whitespace-nowrap"
                  style={{ color: TEAL_600 }}
                >
                  OUR HERITAGE
                </span>
              ...
              >
                <Link
                  href="/Contact"
                  className="inline-flex items-center gap-3 w-fit transition-transform duration-300 hover:-translate-y-0.5"
                  style={{
            ...
            <div className="relative w-full" style={{ aspectRatio: '16/9', background: NAVY_DEEP }}>
              ...
              <motion.div
                ...
                animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 15 }}
                transition={{ delay: 0.4 }}
                className="absolute left-4 right-4 bottom-4 flex items-center gap-4 rounded-[18px]"
                style={{
                  padding: '12px 16px',
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    Historic architecture meets modern facilities
                  </p>
                </div>
                <div 
